...
public class ShopingAddressActivity extends BaseActivity implements OnClickListener {
    ...
    List<AddressListResult.DataEntity.AddressListEntity> mdata = new ArrayList<>();
    ...
    private void initView() {
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                AddressListResult.DataEntity.AddressListEntity addressListEntity = mdata.get(position);
